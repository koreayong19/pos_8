...
const int channelID = 931761;
String writeAPIKey = "D4NQ354W2XRCURI2"; 
const char* server = "api.thingspeak.com";
const int postingInterval = 10 * 1000; 


//자신의 thingspeak 채널의 Read API key 입력
const char * ReadapiKey="MHMG4UXL6R4M3UGT";
const int FieldNumber_BPM = 4;
...
void Get_BPM(){
  long BPM = ThingSpeak.readLongField(channelID, FieldNumber_BPM, ReadapiKey);
  OLED.clearDisplay();
  OLED.setTextWrap(false);
  OLED.setTextSize(3);
  OLED.setTextColor(WHITE);
